...
if (!empty($_SESSION['errors'])) {
  ...
  redirect('/dao-sample-abstract/user/signup.php');
}
...
if (!empty($_SESSION['errors'])) redirect('/dao-sample-abstract/user/signup.php');

// ユーザーの保存
$userDao->create($userName, $mail, $password);

$_SESSION['message'] = "登録できました。";
redirect('/dao-sample-abstract/user/signin.php');
